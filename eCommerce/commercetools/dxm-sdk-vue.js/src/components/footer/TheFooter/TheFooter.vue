                  ...
                  <div class="footer-column footer-column-1">
                      <div class="footer-widget footer-about-2 mb-30">
                          <div class="footer-logo">
                              <a href="index.html">
                                <img src="https://s3.surety.financial.cprd.io/Skunks-Works/commercetools-Vue-SDK/_Assets/images/logo.svg" alt="logo">
                              </a>
                          </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                      <div class="footer-widget payments-img">
                          <a href="#">
                            <img src="https://s3.surety.financial.cprd.io/Skunks-Works/commercetools-Vue-SDK/_Assets/images/payments.png" alt="payments">
                          </a>
                      </div>
                  </div>
              </div>

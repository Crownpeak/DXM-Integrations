...
%>
<li data-test="category-1st-level" class="dropdown menu-large">
    <a href="<%= new Href().ComponentOutput(asset, context, "link", index) %>" class="dropdown-toggle" data-test="category-1st-level-link">
        <%= panel["text"] %>
    </a>
</li>
<%
